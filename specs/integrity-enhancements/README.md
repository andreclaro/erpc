...
| `09-existing-vs-proposed-checks.md` | Check-by-check comparison of the 33 existing integrity checks (upstream main @ `38db1695`) against this proposal: what is kept, re-anchored, added, or removed |
